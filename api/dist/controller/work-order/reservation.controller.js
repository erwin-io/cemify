...
let WorkOrderController = class WorkOrderController {
    ...
    async create(workOrderDto) {
        ...
        try {
            ...
            res.success = true;
            res.message = `WorkOrder ${api_response_constant_1.SAVING_SUCCESS}`;
            return res;
        }
        catch (e) {
            res.success = false;
    ...
    async update(workOrderCode, dto) {
        ...
        try {
            ...
            res.success = true;
            res.message = `WorkOrder ${api_response_constant_1.UPDATE_SUCCESS}`;
            return res;
        }
        catch (e) {
            res.success = false;
    ...
    async updateStatus(workOrderCode, dto) {
        ...
        try {
            ...
            res.success = true;
            res.message = `WorkOrder status ${api_response_constant_1.UPDATE_SUCCESS}`;
            return res;
        }
        catch (e) {
            res.success = false;
