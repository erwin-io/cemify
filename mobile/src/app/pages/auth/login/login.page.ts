          ...
          async (res: ApiResponse<Users>) => {
            if (res.success) {
              ...
              const subscriptionId =
                this.storageService.getOneSignalSubscriptionId();
              if (
                subscriptionId &&
                subscriptionId !== '' &&
                subscriptionId !== null &&
                !subscriptionId?.toString().includes('null')
              ) {
                await this.userOneSignalSubscriptionService
                  .create({
                    userId: res.data?.userId,
                    subscriptionId,
                  })
                  .toPromise()
                  .catch(async (firebaseRes: any) => {
